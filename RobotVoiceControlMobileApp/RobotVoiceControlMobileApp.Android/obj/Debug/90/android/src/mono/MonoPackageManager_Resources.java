...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "RobotVoiceControlMobileApp.Android.dll" comes first in this list. */
		"RobotVoiceControlMobileApp.Android.dll",
		"FormsViewGroup.dll",
		"Microsoft.CognitiveServices.Speech.csharp.dll",
		"Plugin.BLE.Abstractions.dll",
		"Plugin.BLE.dll",
		"RobotVoiceControlMobileApp.dll",
